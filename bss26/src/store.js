...
const store = createStore({
  state: {
    ...
    listUser:[
      {id: 2, userName: 'binh1', gender: 'nu', dateOfBirth: '02-07-2005', address: '1234 em co danh roi nhip nao khong'},
      {id: 3, userName: 'binh2', gender: 'nam', dateOfBirth: '03-07-2005', address: '1234 em co danh roi nhip nao khong'},
